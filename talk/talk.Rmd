...
### What is *reproducible analysis*\footnote{
...
#### Popular Instances\footnote{see also \url{http://cran.r-project.org/web/views/ReproducibleResearch.html}}
* Sweave
* brew
* knitr
...
# Markdown
### What is markdown\footnote{see also: \url{http://daringfireball.net/projects/markdown/ }}?
...
* Inserts MathJaX script reference into HTML\footnote{getting started: \url{http://jeromyanglim.blogspot.com.au/2010/10/getting-started-with-writing.html}} header
